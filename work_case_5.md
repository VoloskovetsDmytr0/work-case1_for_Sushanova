...
## 1.3 Порівняння систем: Linux 🆚 Windows 

Основна концептуальна відмінність полягає в архітектурі файлової системи та способі взаємодії з користувачем.

| Характеристика | Linux 🐧 | Windows  |
| :--- | :--- | :--- |
| **Робота з носіями** | Використовує **монтування** в існуючі папки | Створює окремі логічні диски (**C:, D:, E:**) |
| **Структура ФС** | **Єдине дерево** (все починається з кореня `/`) | Розділена на незалежні розділи |
| **Інтерфейс** | Пріоритет терміналу (CLI) та кастомізація | Орієнтація на графічний інтерфейс (GUI) |
| **Пристрої** | «Все є файлом» (навіть флешка — це шлях) | Пристрої як окремі абстракції в системі |
---
